...
// in mockito_mocktail_migration_helper/test/fixtures/test_4.dart.
...
class MockTestClass1 extends _i1.Mock implements _i2.TestClass1 {
  ...
  int call(int? v) =>
      (super.noSuchMethod(Invocation.method(#call, [v]), returnValue: 0)
          as int);
  @override
  int call2(int? v, {bool? flag}) =>
      (super.noSuchMethod(Invocation.method(#call2, [v], {#flag: flag}),
          returnValue: 0) as int);
  @override
  _i3.Future<String> call3({String? s}) =>
      (super.noSuchMethod(Invocation.method(#call3, [], {#s: s}),
